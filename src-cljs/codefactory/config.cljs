...
(def ^:export default-config
  {:modules
   ...
   [[:splitx2 {:label "split x2" :node (mg/subdiv :cols 2) :view (view-face :b)}]
    ...
    [:sep]
    [:tiltwf {:label "tilt left" :node (mg/skew :w :f :offset 0.5) :view (view-face :s)}]
    [:tiltef {:label "tilt right" :node (mg/skew :e :f :offset 0.5) :view (view-face :s)}]
    [:tiltnf {:label "tilt top" :node (mg/skew :n :f :offset 0.5) :view (view-face :w)}]
    [:tiltsf {:label "tilt bottom" :node (mg/skew :s :f :offset 0.5) :view (view-face :w)}]
    [:tiltfe {:label "tilt front" :node (mg/skew :f :e :offset 0.5) :view (view-face :w)}]
    [:tiltbe {:label "tilt back" :node (mg/skew :b :e :offset 0.5) :view (view-face :w)}]
    [:sep]
